...
import { PaymentCardComponents } from './payment-card-components.component';
import { ICardDetails } from '@cc-project/credit-card/domain/i-card-details';
import { PaymentCardService } from '@cc-project/credit-card/service/payment-card.service';
import { PaymentCardNumberPipe } from '@cc-project/credit-card/pipe/payment-card-number/payment-card-number.pipe';
import { ValidThruPipe } from '@cc-project/credit-card/pipe/valid-thru/valid-thru.pipe';

describe('PaymentCardComponent', () => {
  let component: PaymentCardComponents;
  let fixture: ComponentFixture<PaymentCardComponents>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, CommonModule],
      declarations: [PaymentCardComponents, PaymentCardNumberPipe, ValidThruPipe],
      providers: [PaymentCardService],
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(PaymentCardComponents);
